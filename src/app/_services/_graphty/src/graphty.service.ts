...
import { GQLQProducerInterface } from './graphty.interface';
...
export class GraphtyService {
   ...
   * @returns {string}
   */
  private setFuntion(funName: string, args: any = null): string {
   ...
   * @returns {string}
   **/
  private setFunBody(funBody: Array<string | any>): string {
   ...
   * @returns {GqlQuery}
   **/
  public stagnation(graphStruct: GQLQProducerInterface): GqlQuery {
    let query = 
   ...
   * @returns {GqlQuery}
   **/
  public mutation(graphStruct: GQLQProducerInterface): GqlQuery {
    let query = 
